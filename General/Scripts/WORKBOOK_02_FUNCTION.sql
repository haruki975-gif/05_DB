...
WHERE TB_DEPARTMENT.DEPARTMENT_NO = '002';
...
SELECT 
	...
	TO_NUMBER('19' || SUBSTR(STUDENT_SSN,1,2)) AS "출생년도",
	EXTRACT(YEAR FROM ENTRANCE_DATE) - TO_NUMBER('19' || SUBSTR(STUDENT_SSN,1,2)) AS "나이"
FROM TB_STUDENT
WHERE 
...
SELECT 
	...
	COUNT(
		CASE WHEN ABSENCE_YN = 'Y' THEN 1 END
	) AS "휴학생 수"
