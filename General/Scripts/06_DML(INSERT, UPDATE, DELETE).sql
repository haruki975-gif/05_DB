...
-- BONUS를 0.1로 변경
SELECT EMP_NAME, BONUS FROM EMPLOYEE2 WHERE BONUS IS NULL;
UPDATE EMPLOYEE2 SET BONUS = 0.1 WHERE BONUS IS NULL; -- 15행
...
WHERE EMP_NAME = '방명수'; -- 1행 실행

SELECT EMP_NAME, SALARY, BONUS 
FROM EMPLOYEE2 WHERE EMP_NAME IN ('방명수', '유재식');
ROLLBACK;
...
WHERE EMP_NAME IN ('방명수', '노옹철', '정중하', '전형돈', '하동운');
